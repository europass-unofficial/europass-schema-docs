...
graph TD
    subgraph CandidateSupplierType
        ...
        A -- "It contains information about the supplier of candidate details." --> A
        B -- "It contains identifier of registered partner system. The id is provided once registered by the Interoperability..." --> B
        C -- "The name of the candidate supplier. For example, name of the job board. The name of the employee who made the..." --> C
        ...
        F -- "To distinguish to primary or first source in cases where the same candidate was supplied by several sources. May be..." --> F
